...
class DatabaseHelper {
  ...
  Future initializeDB() async {
    ...
    database = await openDatabase(path, version: 1,
      ...
      ''');
        batch.insert(currencyTableName, (new Currency(
        ...
        batch.insert(currencyTableName,
          (new Currency(shortName: 'AMD', longName: 'Armenian Dram'))
            .toMap());
        batch.insert(currencyTableName, (new Currency(shortName: 'ANG',
        ...
        batch.insert(currencyTableName, (new Currency(shortName: 'BAM',
        ...
        batch.insert(currencyTableName, (new Currency(shortName: 'MRO',
